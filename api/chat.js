const KNOWLEDGE = {
  el: {
    ...
    vip: 'Το VIP είναι ένα premium και πιο άνετο τραπέζι με καναπέ, ιδανικό για παρέες 6–7 ατόμων. Για VIP τραπέζι απαιτείται ελάχιστη κατανάλωση 3 φιαλών.',
    ...
    vip_explain: 'Το VIP είναι ένα premium και πιο άνετο τραπέζι με καναπέ, ιδανικό για παρέες 6–7 ατόμων. Για VIP τραπέζι απαιτείται ελάχιστη κατανάλωση 3 φιαλών.',
  ...
  en: {
    ...
    vip: 'VIP is a premium, more spacious and comfortable table with sofa seating, ideal for groups of 6–7 people. VIP tables require a minimum consumption of 3 bottles.',
    ...
    vip_explain: 'VIP is a premium, more spacious and comfortable table with sofa seating, ideal for groups of 6–7 people. VIP tables require a minimum consumption of 3 bottles.',
